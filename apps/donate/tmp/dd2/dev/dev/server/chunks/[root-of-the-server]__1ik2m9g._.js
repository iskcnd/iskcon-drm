...
"[project]/apps/donate/src/lib/db.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/donate/src/lib/util.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/donate/src/lib/zoho.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$donate$2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/donate/src/lib/db.js [app-route] (ecmascript)");
;
...
async function processOutbox(limit = 20) {
    ...
    const due = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$donate$2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["q"])(`SELECT id, donation_id, payload, attempts FROM webhook_outbox
    ...
    for (const row of due.rows){
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$donate$2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["q"])(`UPDATE webhook_outbox SET status='sent', sent_at=now(), attempts=attempts+1 WHERE id=$1`, [
                row.id
            ]);
            sent += 1;
        } catch (err) {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$donate$2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["q"])(`UPDATE webhook_outbox
...
"[project]/apps/donate/src/lib/ops-donate.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$donate$2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/donate/src/lib/db.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$donate$2f$src$2f$lib$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/donate/src/lib/util.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$donate$2f$src$2f$lib$2f$zoho$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/donate/src/lib/zoho.js [app-route] (ecmascript)");
;
;
;
...
async function getPageContent() {
    const cats = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$donate$2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["q"])(`SELECT id, slug, kind, icon, tag, min_amount, name_i18n, line_i18n, emo_i18n, presets
       FROM seva_category
      WHERE is_active AND show_on_page
      ORDER BY display_order, id`);
    const camps = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$donate$2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["q"])(`SELECT c.id, c.slug, c.title_i18n, c.line_i18n, c.goal_amount, c.starts_on, c.ends_on, c.presets,
...
async function lookupByMobile(mobile10) {
    const r = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$donate$2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["q"])(`SELECT id, display_name, area, city
       FROM person
    ...
    return r.rows.map((p)=>({
            person_id: p.id,
            mask: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$donate$2f$src$2f$lib$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["maskName"])(p.display_name),
            area: [
                p.area,
                p.city
            ].filter(Boolean).join(', ')
...
async function createDonation(input) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$donate$2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["tx"])(async (c)=>{
       ...
       RETURNING id`, [
        ...
        const ref = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$donate$2f$src$2f$lib$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["orderRef"])();
...
async function markAttemptFailed(ref, raw) {
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$donate$2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["q"])(`UPDATE payment_attempt SET status='failure', raw_response=$2 WHERE order_ref=$1 AND status='initiated'`, [
        ref,
...
async function markPaid(ref, { gatewayTxnId, mode, raw }) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$donate$2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["tx"])(async (c)=>{
        ...
        if (d.rows.length) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$donate$2f$src$2f$lib$2f$zoho$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["enqueueZohoWebhook"])(c, donation_id);
        }
...
"[project]/apps/donate/src/app/api/categories/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$donate$2f$src$2f$lib$2f$ops$2d$donate$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/donate/src/lib/ops-donate.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$donate$2f$src$2f$lib$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/donate/src/lib/util.js [app-route] (ecmascript)");
;
;
async function GET() {
    try {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$donate$2f$src$2f$lib$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["json"])(await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$donate$2f$src$2f$lib$2f$ops$2d$donate$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getPageContent"])());
    } catch (err) {
        console.error('categories:', err);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$donate$2f$src$2f$lib$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["bad"])('Could not load sevas', 500);
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__1ik2m9g._.js.map